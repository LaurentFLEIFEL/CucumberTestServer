...
import com.lfl.utils.CucumberExecutionContext;
import com.lfl.utils.ExitStatus;
...
public final class CucumberRunner {
    ...
    public static class Builder {
        ...
        public CucumberRunner build() {
            final ObjectFactoryServiceLoader objectFactoryServiceLoader = new ObjectFactoryServiceLoader(
                    runtimeOptions);

            final ObjectFactorySupplier objectFactorySupplier = this.objectFactorySupplier != null
                                                                ? this.objectFactorySupplier
                                                                : (runtimeOptions.isMultiThreaded()
            ...
            return new CucumberRunner(exitStatus, context, filter, limit, featureSupplier, executor, pickleOrder);
        }

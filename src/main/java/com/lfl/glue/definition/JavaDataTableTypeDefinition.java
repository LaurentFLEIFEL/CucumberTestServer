...
public class JavaDataTableTypeDefinition extends AbstractDatatableElementTransformerDefinition
        implements DataTableTypeDefinition {

    private final DataTableType dataTableType;

    public JavaDataTableTypeDefinition(Method method, Lookup lookup, String[] emptyPatterns) {
